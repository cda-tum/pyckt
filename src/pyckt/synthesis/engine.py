...
Given a populated :class:`~pyckt.synthesis.library.TopologyLibrary`, a
:class:`~pyckt.io.circuit_info_parser.Specifications` object, and optional
:class:`~pyckt.io.technology_parser.TechnologyParams`, it:
...
class SynthesisEngine:
    ...
    specifications:
        ...
        :class:`~pyckt.io.circuit_info_parser.Specifications` instance or any
    ...
    technology:
        ...
        (:class:`~pyckt.io.technology_parser.TechnologyParams`).
